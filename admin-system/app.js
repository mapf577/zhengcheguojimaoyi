...
const adminTranslations = {
  en: {
    ...
    "login.submit": "Login",
    "login.hint": "Default development account: admin / admin123. Change it with environment variables before deployment.",
  ...
  zh: {
    ...
    "login.password": "密码",
    "login.submit": "登录",
    "login.hint": "默认开发账号：admin / admin123。正式部署前请使用环境变量修改。",
    "nav.dashboard": "仪表盘",
    "nav.vehicles": "整车管理",
    "nav.parts": "零配件管理",
    "nav.inquiries": "询盘管理",
